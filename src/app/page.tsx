...
const Home = () => {
  ...
  const [renderUI, setRenderUI] = useState<boolean>(false);
    ...
    <div>
      {useUserStore.getState().user._id ? (
        <>
          ...
          {/* CTA Section */}
          {/* Explore Section */}
          <div className="flex items-center lg:pl-5 mt-10">
            <h1 className="pl-2 lg:pl-3.5 font-bold text-2xl lg:text-4xl text-blue-900">Practice!</h1>
          </div>
          <div className="lg:px-16 lg:p-6 px-2">
            <div className="flex lg:flex-nowrap flex-wrap space-y-2 lg:space-y-0 space-x-0 lg:space-x-2 mt-px">
              <Option
                svg={
                  <BookSVG />
                }
          ...
          {/* Explore Section */}
          <div className="flex items-center lg:pl-5 mt-10">
            <h1 className="pl-2 lg:pl-3.5 font-bold text-2xl lg:text-4xl text-red-600">Stats</h1>
          </div>
